...
!function($) {
    ...
    CalendarApp.prototype.onEventClick =  function (calEvent, jsEvent, view) {
        var $this = this;
            ...
            form.append("<div class='input-group'><input class='form-control' type=text value='' /><span class='input-group-append'><button type='submit' class='btn btn-success btn-md'>Save</button></span></div>");
            $this.$modal.modal({
                backdrop: 'static'
            });
 ...
 //                        className: categoryClass
        ...
        var defaultEvents =  [
        <?php foreach ($jadwal_kerja as $k) : ?>
        {
                title: '<?= $k['nama'] ?>',
                start: new Date($.now() + <?= strtotime($k['waktu']) ?>),
